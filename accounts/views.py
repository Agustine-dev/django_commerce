...
def register(request):
    ...
    context = {
        ...
        'page_description': _("Ecommerce site"
...
def login(request):
    ...
    context = {
        ...
        'page_description': _("Ecommerce site. This is the login page."),
    }
    if request.method == 'POST':
        email = request.POST['email']
        password = request.POST['password']
        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    email_template_name = "password_reset_email.txt"  # noqa
                    c = {
                        "email": user.email,
                        'domain': 'real.lex',
                        'site_name': 'Ecommerce site kenya',
                    ...
                    try:
                        send_mail(subject, email, 'nagustinenyaanga@gmail.com',
...
class ProfileUpdateView(SuccessMessageMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['page_description'] = _("PRofile page manager"
